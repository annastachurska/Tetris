...
There are four **additional features** of this game compared with the original one:
...
**Things to do:**:
1. Boxes with description of action of additional buttons  - they should appear when the mouse will be over button of interest.
2. Information about the bomb in another section on the screen or in introduction part.
3. Check the correctness of Chuck Norris Joke.
